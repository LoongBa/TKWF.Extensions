...
public partial class ApprovalCCEntity : IDomainEntity
{
    [NotMapped]
    ...
    {
        var dto = ApprovalCCEntityDto.FromEntity(this);
        if (dto is TDto result) return result;
        throw new InvalidCastException($"无法将 {nameof(ApprovalCCEntityDto)} 转换为请求的 {typeof(TDto)}");
    }

    public ApprovalCCEntityDto ToDto() => ApprovalCCEntityDto.FromEntity(this);
