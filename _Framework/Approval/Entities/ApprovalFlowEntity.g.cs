...
public partial class ApprovalFlowEntity : IDomainEntity
{
    [NotMapped]
    ...
    {
        var dto = ApprovalFlowEntityDto.FromEntity(this);
        if (dto is TDto result) return result;
        throw new InvalidCastException($"无法将 {nameof(ApprovalFlowEntityDto)} 转换为请求的 {typeof(TDto)}");
    }

    public ApprovalFlowEntityDto ToDto() => ApprovalFlowEntityDto.FromEntity(this);
