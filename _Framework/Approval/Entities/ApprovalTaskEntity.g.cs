...
public partial class ApprovalTaskEntity : IDomainEntity
{
    [NotMapped]
    ...
    {
        var dto = ApprovalTaskEntityDto.FromEntity(this);
        if (dto is TDto result) return result;
        throw new InvalidCastException($"无法将 {nameof(ApprovalTaskEntityDto)} 转换为请求的 {typeof(TDto)}");
    }

    public ApprovalTaskEntityDto ToDto() => ApprovalTaskEntityDto.FromEntity(this);
