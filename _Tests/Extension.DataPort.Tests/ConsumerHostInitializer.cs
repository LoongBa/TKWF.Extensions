...
/// <para>V4.9.85 (ADR47)：消费方显式启用 DataPort 扩展——<see cref="TKWFEnabledExtensionAttribute"/>
/// 声明后，SG1b 将 DataPort 的能力清单聚合进消费方的领域权威注册。</para>
/// </summary>
...
/// <summary>消费方最小元数据上下文（无业务实体/服务——本测试仅验证扩展 DI 注册）。</summary>
