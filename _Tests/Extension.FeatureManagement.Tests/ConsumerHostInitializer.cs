...
/// <para>V4.9.85 (ADR47)：消费方显式启用 FeatureManagement 扩展——<see cref="TKWFEnabledExtensionAttribute"/>
/// 声明后，SG1b 将 FeatureManagement 的能力清单（GeneratedControllerCatalog）聚合进本消费方的
...
/// <summary>消费方最小元数据上下文（无业务实体/服务——本测试仅验证扩展控制器生成 + 扩展接线）。</summary>
